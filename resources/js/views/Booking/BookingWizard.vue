                ...
                <fieldset :class="current == 1 ? 'd-block' : 'd-none'">
                    <div class="card ">
                        <div class="card-body m-4">
                            ...
                            <div class=" mt-4">
                                <button type="button" name="next" @click="changeTab(2)" class="btn btn-primary next action-button float-end" value="Next" v-if="booking.address" >{{__('messages.continue')}}</button>
                                <button type="button" name="next"  class="btn btn-primary next action-button float-end" value="Next"  v-else>{{__('messages.continue')}}</button>
