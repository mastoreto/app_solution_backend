                                ...
                                <ul class="nav flex-column nav-pills mb-3 nav-fill tabslink" id="tabs-text" role="tablist">
                                    ...
                                    @else
                                        @hasanyrole('admin|demo_admin')
                                            ...
                                            <li class="nav-item">
                                                <a href="javascript:void(0)" data-href="{{ route('layout_page') }}?page=sidebar-setting" data-target=".paste_here" class="nav-link {{$page=='sidebar-setting'?'active':''}}"  data-toggle="tabajax" rel="tooltip"> {{ __('messages.sidebar_settings') }}</a>
                                            </li>
                                            <li class="nav-item">
